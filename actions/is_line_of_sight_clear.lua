-- ia_fake_player/actions/is_line_of_sight_clear.lua
...
function ia_fake_player.actions.is_line_of_sight_clear(pos1, pos2) -- TODO this needs to be extensible (no-clipping ability)
    ...
    local ground = ia_fake_player.actions.find_ground_level(mid_pos, 1, 2)
