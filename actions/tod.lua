...
function ia_fake_player.actions.is_dusk()
    local t = minetest.get_timeofday()
...
function ia_fake_player.actions.is_noon()
    local t = minetest.get_timeofday()
    return t >= 0.45 and t <= 0.55
end

--- Predicate: Is it the middle of the night?
function ia_fake_player.actions.is_midnight()
    local t = minetest.get_timeofday()
...
function ia_fake_player.actions.get_time_phase()
    local t = minetest.get_timeofday()
