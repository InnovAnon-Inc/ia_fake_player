-- ia_fake_player/actions/primitive/walk.lua

--- Level 1: Atomic Action (Physics)
-- Moves the mob toward a target position and updates its rotation.
function ia_fake_player.actions.primitive.walk(self, target_pos)
    ...
    if dist > 0.2 then
        ...
        ia_fake_player.actions.primitive.set_animation(self, 'WALK')
        return true
    else
