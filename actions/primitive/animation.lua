-- ia_fake_player/actions/primitive/animation.lua
-- TODO 3d_armor_flyswim

ia_fake_player.actions.primitive.animation_frames = {
    STAND     = { x =   0, y =  79, },
    LAY       = { x = 162, y = 166, },
    WALK      = { x = 168, y = 187, },
    MINE      = { x = 189, y = 198, },
...
-- @param state The string key from ia_fake_player.actions.primitive.animation_frames (e.g., "WALK")
-- @param speed Animation speed (default 30)
-- @param loop Whether the animation should repeat (default true)
function ia_fake_player.actions.primitive.set_animation(self, state, speed, loop)
	--minetest.log('ia_fake_player.actions.primitive.set_animation()')
    local frames = ia_fake_player.actions.primitive.animation_frames[state]
