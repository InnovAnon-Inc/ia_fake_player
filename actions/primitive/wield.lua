-- ia_fake_player/actions/primitive/wield.lua
...
function ia_fake_player.actions.primitive.wield_by_condition(self, condition)
	minetest.log('ia_fake_player.actions.primitive.wield_by_condition()')
