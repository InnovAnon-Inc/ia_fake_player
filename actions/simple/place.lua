-- ia_fake_player/actions/simple/place.lua
...
function ia_fake_player.actions.simple.place(self, pos)
    minetest.log('ia_fake_player.actions.simple.place()')
    ...
    if success then
        ...
        ia_fake_player.actions.simple.play_node_sound(node_name, pointed_thing.above, "place")
