-- ia_fake_player/actions/simple/rightclick.lua
...
function ia_fake_player.actions.simple.right_click(self, pos, sneak)
	minetest.log('ia_fake_player.actions.simple.rightclick()')
    ...
    if not sneak and def and def.on_rightclick then
        ...
        success = ia_fake_player.actions.simple.place(self, pos)
    end
